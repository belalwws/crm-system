      ...
      <main className="flex items-center justify-center pt-24 pb-12 px-6 min-h-screen">
        <div className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="hidden lg:block">
            <div className="inline-flex items-center gap-2 bg-white dark:bg-neutral-900 rounded-full px-4 py-1.5 mb-6 shadow-sm border border-neutral-200 dark:border-neutral-800">
              <Rocket className="w-4 h-4 text-blue-500" />
              <span className="text-sm text-neutral-600 dark:text-neutral-400">Start your free trial</span>
            </div>
          ...
          <div>
            ...
            <div className="lg:hidden text-center mb-8">
              <div className="inline-flex items-center gap-2 bg-white dark:bg-neutral-900 rounded-full px-4 py-1.5 mb-4 shadow-sm border border-neutral-200 dark:border-neutral-800">
                <Rocket className="w-4 h-4 text-blue-500" />
                <span className="text-sm text-neutral-600 dark:text-neutral-400">Start free</span>
              </div>
              ...
              <SignUp
                appearance={{
                  elements: {
                    ...
                    otpCodeFieldInput: "w-12 h-12 text-center text-xl font-semibold border border-neutral-300 dark:border-neutral-600 rounded-lg bg-white dark:bg-neutral-800 text-neutral-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-black dark:focus:ring-white",
                  },
                  layout: {
