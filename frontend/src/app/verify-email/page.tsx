        ...
        <div className="bg-white dark:bg-neutral-900 rounded-2xl shadow-sm border border-neutral-200 dark:border-neutral-800 p-8">
          {status === 'verifying' && (
            <div className="text-center py-8">
              ...
              <h2 className="text-xl font-bold text-neutral-900 dark:text-white mb-2">Verifying Email...</h2>
              <p className="text-neutral-500 dark:text-neutral-400">Please wait while we verify your email address.</p>
            </div>
          )}
          ...
          {status === 'success' && (
            <div className="text-center py-4">
              ...
              <h2 className="text-xl font-bold text-neutral-900 dark:text-white mb-2">Email Verified!</h2>
          ...
          {status === 'error' && (
            <div className="text-center py-4">
              ...
              <p className="text-neutral-500 dark:text-neutral-400 mb-6">{errorMsg}</p>
              <Link
                href="/dashboard"
                className="inline-flex px-6 py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-medium transition-colors"
              >
